...
Revision ID: 6e37f66e24a7
Revises: 
Create Date: 2023-08-01 14:59:21.602518
...
def upgrade():
    ...
    with op.batch_alter_table('mms_msg_log_202308', schema=None) as batch_op:
        batch_op.drop_index('IDX_MMS_MSG_LOG_202308_1')
        batch_op.drop_index('IDX_MMS_MSG_LOG_202308_2')

    op.drop_table('mms_msg_log_202308')
    ...
    with op.batch_alter_table('sms_msg_log_202308', schema=None) as batch_op:
        batch_op.drop_index('IDX_SMS_MSG_LOG_202308_1')
        batch_op.drop_index('IDX_SMS_MSG_LOG_202308_2')

    op.drop_table('sms_msg_log_202308')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('sms_msg_log_202308',
    ...
    with op.batch_alter_table('sms_msg_log_202308', schema=None) as batch_op:
        batch_op.create_index('IDX_SMS_MSG_LOG_202308_2', ['PHONE'], unique=False)
        batch_op.create_index('IDX_SMS_MSG_LOG_202308_1', ['STATUS', 'REQDATE'], unique=False)
    ...
    op.create_table('mms_msg_log_202308',
    sa.Column('MSGKEY', mysql.BIGINT(display_width=20), autoincrement=False, nullable=False),
    sa.Column('SERIALNUM', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('ID', mysql.VARCHAR(length=16), nullable=True),
    sa.Column('STATUS', mysql.VARCHAR(length=2), server_default=sa.text("'1'"), nullable=False),
    ...
    with op.batch_alter_table('mms_msg_log_202308', schema=None) as batch_op:
        batch_op.create_index('IDX_MMS_MSG_LOG_202308_2', ['PHONE'], unique=False)
        batch_op.create_index('IDX_MMS_MSG_LOG_202308_1', ['STATUS', 'REQDATE'], unique=False)
