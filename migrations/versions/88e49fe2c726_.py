...
Revision ID: 88e49fe2c726
Revises: 
Create Date: 2023-07-10 16:45:34.951318
...
def upgrade():
    ...
    with op.batch_alter_table('sms_msg_log_202307', schema=None) as batch_op:
        batch_op.drop_index('IDX_SMS_MSG_LOG_202307_1')
        batch_op.drop_index('IDX_SMS_MSG_LOG_202307_2')

    op.drop_table('sms_msg_log_202307')
    ...
    with op.batch_alter_table('mms_msg_log_202307', schema=None) as batch_op:
        batch_op.drop_index('IDX_MMS_MSG_LOG_202307_1')
        batch_op.drop_index('IDX_MMS_MSG_LOG_202307_2')

    op.drop_table('mms_msg_log_202307')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('mms_msg_log_202307',
    ...
    with op.batch_alter_table('mms_msg_log_202307', schema=None) as batch_op:
        batch_op.create_index('IDX_MMS_MSG_LOG_202307_2', ['PHONE'], unique=False)
        batch_op.create_index('IDX_MMS_MSG_LOG_202307_1', ['STATUS', 'REQDATE'], unique=False)
    ...
    op.create_table('sms_msg_log_202307',
    sa.Column('MSGKEY', mysql.BIGINT(display_width=20), autoincrement=False, nullable=False),
    sa.Column('REQDATE', mysql.DATETIME(), nullable=False),
    sa.Column('SERIALNUM', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('ID', mysql.VARCHAR(length=16), nullable=True),
    ...
    with op.batch_alter_table('sms_msg_log_202307', schema=None) as batch_op:
        batch_op.create_index('IDX_SMS_MSG_LOG_202307_2', ['PHONE'], unique=False)
        batch_op.create_index('IDX_SMS_MSG_LOG_202307_1', ['STATUS', 'REQDATE'], unique=False)
