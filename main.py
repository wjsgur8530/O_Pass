...
def register():
    if request.method == 'POST':
        ...
        #==============현준============================
            ...
            flash("이메일은 40자 이하여야 합니다.")
        #==============현준============================
        elif len(username) < 2:
            flash("이름은 2자 이상이어야 합니다.")
        #==============현준============================
        elif len(username) > 20:
            flash("이름은 20자 이하여야 합니다.")
        #==============현준============================
        elif password1 != password2 :
            flash("비밀번호와 비밀번호 재입력이 서로 다릅니다.")
        #==============현준============================
        elif len(password1) < 8:
            flash("비밀번호는 8자 이상이어야 합니다.")
        elif len(password1) > 20:  # 비밀번호 길이 제한 추가
            flash("비밀번호는 20자 이하여야 합니다.")
        ...
        #==============현준============================
            ...
            user.password_changed_at = datetime.now()  # 현재 시간으로 패스워드 변경 날짜 설정
